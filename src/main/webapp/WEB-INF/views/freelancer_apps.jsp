...
<div class="container">
    <div class="row">
        <div class="col-md-10 col-md-offset-1 panel-body">
            ...
            <c:if test="${!empty freelancerApps}">
                <table class="table table-hover borderless table-stripedd">
                    <c:forEach items="${freelancerApps}" var="application">
                        <tr>
                            <td>
                                <div class="row">
                                    <div class="col-md-12">
                                        <header>
                                            <h2 class="m-0">
                                                <a class="break visited"
                                                   ...
                                                   data-relevance='{}'
                                                   data-position="1"
                                                   href="/projectdata/${application.project}"
                                                   target="_blank">${application.project}
                                                </a>
                                            </h2>
                                        </header>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <span>
                                    <h3>Status: ${application.status.status_name}</h3>
                                    </span>
                                </div>
